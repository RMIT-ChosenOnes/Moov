                        ...
                        while ($car_result = mysqli_fetch_assoc($get_car_result)) {
                            ...
                            if (isset($_GET['bookView']) && $_GET['bookView'] == 'grid') {
                                ...
                                if (isset($_SESSION['moov_user_license_expired']) && $_SESSION['moov_user_license_expired'] == TRUE) {
                                    echo '<a class="btn btn-primary btn-block" role="button" href="/moov/my-account?tab=myLicense&ref=' . urlencode('/moov/book' . $search_engine_url) . '">Update Driving License to Book</a>';
                                    
                                } else if (isset($_SESSION['moov_user_logged_in']) && $_SESSION['moov_user_logged_in'] == TRUE) {
